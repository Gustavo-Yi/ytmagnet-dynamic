      ...
      >
        ...
        {activeTooltip === 'whatsapp' && (
          <div className="fc-tooltip">
            ...
            <p className="fc-tooltip-value">+86 131 0749 7745</p>
          </div>
        )}
      </div>
      ...
      >
        ...
        {activeTooltip === 'email' && (
          <div className="fc-tooltip">
            ...
            <p className="fc-tooltip-value">{EMAIL}</p>
          </div>
        )}
      </div>

      {/* Scroll to Top — always visible */}
      <div className="fc-btn fc-top" onClick={scrollToTop} aria-label="Scroll to top">
